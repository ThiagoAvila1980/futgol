...
>(({ className, hoverEffect = false, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      hoverEffect &&
        "transition-transform hover:-translate-y-1 hover:shadow-premium-hover cursor-pointer",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl font-heading font-bold text-navy-900 leading-none tracking-tight",
      className
    )}
    {...props}
  />
