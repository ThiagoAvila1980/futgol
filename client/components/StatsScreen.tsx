                ...
                {filteredStats.map((p, index) => {
                    ...
                    return (
                        <Card
                            key={p.id}
                            className={cn(
                                "px-4 py-3 flex items-center gap-3 hover:shadow-premium-hover transition-all bg-white",
                        ...
                        >
                            ...
                            <div className="w-11 h-11 rounded-full overflow-hidden bg-brand-100 flex items-center justify-center text-brand-700 font-bold">
                            ...
                            <div className="min-w-0 flex-1">
                                <h4 className="font-black text-navy-900 truncate text-sm leading-tight group-hover:text-brand-600 transition-colors">
                                    {p.nickname || p.name}
                                </h4>
                            ...
                            <div className="flex items-center gap-4 text-[11px] font-black text-navy-700">
                                <div className="flex flex-col items-center min-w-[46px]">
                                    <span className="text-sm leading-none">{p.matches}</span>
                                    <span className="uppercase text-[9px] text-navy-400 mt-0.5">Jogos</span>
                                </div>
                                <div className="flex flex-col items-center min-w-[40px]">
                                    <span className="text-sm leading-none">{p.goals}</span>
                                    <span className="uppercase text-[9px] text-navy-400 mt-0.5">Gols</span>
                                </div>
                                <div className="flex flex-col items-center min-w-[48px]">
                                    <span className="text-sm leading-none">{p.assists}</span>
                                    <span className="uppercase text-[9px] text-navy-400 mt-0.5">Assist.</span>
                                </div>
                                <div className="flex flex-col items-center min-w-[44px]">
                                    <span className="text-sm leading-none">{(p.rating || 0).toFixed(1)}</span>
                                    <span className="uppercase text-[9px] text-navy-400 mt-0.5">Nível</span>
                                </div>
                            </div>
                        </Card>
                    );
